...
export class EmpresaPorteriaController {
  ...
  @ResponseMessage("Empresa de seguridad created")
  ...
  @ApiResponse({ status: 200, type: EmpresaPorteriaResponseDto })
  @ResponseMessage("Empresa de seguridad updated")
  async update(
  ...
  @ApiResponse({ status: 200, type: EmpresaPorteriaResponseDto })
  @ResponseMessage("Empresa de seguridad deactivated")
  ...
  @ApiResponse({ status: 200, type: EmpresaPorteriaResponseDto })
  @ResponseMessage("Empresa de seguridad activated")
  ...
  /** Elimina permanentemente una empresa de seguridad sin relaciones. */
  @Delete(":id")
  @ApiOperation({ summary: "Permanently delete empresa-porteria" })
  @ResponseMessage("Empresa de seguridad deleted")
